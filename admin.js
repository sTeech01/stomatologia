...
document.addEventListener('DOMContentLoaded', function() {
  ...
  window.openDocModal = function(key) {
    ...
    if (dmPhoto) dmPhoto.innerHTML = d.photo ? `<img src="${Utils.escapeHtml(d.photo)}" style="width:100%;height:100%;object-fit:cover;object-position:top;border-radius:inherit"/>` : '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>';
