...
// ── Навигация по хэшу (кнопка "Назад" и прямые ссылки) ──────────
...
// Универсальная отправка данных администратору
...
const DOCTORS = {
  balycheva: {
    photo: 'img/doctors/Балычева Татьяна Валентиновна.webp',
    name: 'Балычева Татьяна Валентиновна',
    spec: 'Детский стоматолог',
    exp: 'Стаж 7 лет',
    about: 'Татьяна Валентиновна специализируется на лечении молочных и постоянных зубов у детей с 3 лет. Умеет создать доверительную атмосферу и найти подход к самому тревожному ребёнку. Проводит профилактику кариеса, фторирование и раннюю ортодонтическую диагностику.',
    edu: [
      { name: 'Костромской государственный медицинский университет', year: 'Стоматология — 2017' },
    ...
    services: ['Лечение молочных зубов', 'Профилактика кариеса', 'Серебрение зубов', 'Фторирование', 'Консультация родителей'],
  },
  galichev: {
    photo: 'img/doctors/Галичев Дмитрий Андреевич.webp',
    name: 'Галичев Дмитрий Андреевич',
    spec: 'Хирург',
    exp: 'Стаж 10 лет',
    about: 'Дмитрий Андреевич — хирург-стоматолог с большим клиническим опытом. Специализируется на сложных удалениях зубов мудрости, лечении воспалительных заболеваний. Работает точно и деликатно — большинство пациентов отмечают минимальный дискомфорт.',
    edu: [
      { name: 'Ярославская государственная медицинская академия', year: 'Стоматология — 2014' },
  ...
  kurilova: {
    photo: 'img/doctors/Курилова Ирина Олеговна.webp',
    ...
    edu: [
      { name: 'Нижегородская государственная медицинская академия', year: 'Стоматология — 2016' },
    ...
    services: ['Исправление прикуса', 'Установка брекетов', 'Подбор элайнеров', 'Установка ретейнеров', 'Консультация ортодонта'],
  },
  rudometkin: {
    photo: 'img/doctors/Рудометкин Олег Иванович.webp',
    ...
    edu: [
      { name: 'Ярославская государственная медицинская академия', year: 'Стоматология — 2012' },
    ...
    services: ['Коронки металлокерамика', 'Циркониевые коронки', 'Виниры', 'Мостовидные протезы', 'Съёмное протезирование'],
  },
  chemodanova: {
    photo: 'img/doctors/Чемоданова Наталия Владимировна.webp',
    name: 'Чемоданова Наталия Владимировна',
    spec: 'Терапевт',
    exp: 'Стаж 9 лет',
    about: 'Наталия Владимировна — терапевт широкого профиля. Специализируется на лечении кариеса, пульпита, периодонтита и эстетической реставрации зубов. Использует современные световые композиты, добиваясь результата, неотличимого от натуральной эмали.',
    edu: [
      { name: 'Костромской государственный медицинский университет', year: 'Стоматология — 2015' },
  ...
  korovkina: {
    photo: 'img/doctors/Коровкина Алина Сергеевна.webp',
    name: 'Коровкина Алина Сергеевна',
    spec: 'Гигиенист, ортодонт',
    exp: 'Стаж 6 лет',
    about: 'Алина Сергеевна совмещает работу гигиениста и ортодонта. Проводит профессиональную чистку зубов, Air Flow и фторирование. Также занимается ортодонтическим лечением на начальных стадиях. Уделяет особое внимание обучению пациентов правилам домашней гигиены.',
    edu: [
      { name: 'Ивановская государственная медицинская академия', year: 'Стоматология — 2018' },
    ],
    courses: [
  ...
  bolshov: {
    photo: 'img/doctors/Большов Сергей Николаевич.webp',
    name: 'Большов Сергей Николаевич',
    spec: 'Ортопед',
    exp: 'Стаж 11 лет',
    about: 'Сергей Николаевич специализируется на протезировании зубов с использованием современных материалов. Восстанавливает жевательную функцию и эстетику улыбки коронками, мостами и винирами. Имеет большой опыт работы со сложными клиническими случаями.',
    edu: [
      { name: 'Костромской государственный медицинский университет', year: 'Стоматология — 2013' },
